...
import { FaCar, FaBiking, FaInfoCircle } from "react-icons/fa";
                            ...
                            <div key={rental._id} style={styles.card}>
                                ...
                                <div style={styles.cardBody}>
                                    ...
                                    <div style={styles.footer}>
                                        <div style={styles.note}><FaInfoCircle size={10} /> Add to your room booking at checkout</div>
                                    </div>
                                </div>
                            </div>
                        ))}
...
const styles = {
    ...
    cardBody: { padding: "24px", display: "flex", flexDirection: "column", gap: "12px" },
    ...
    footer: { marginTop: "12px", borderTop: "1px solid #f1f5f9", paddingTop: "12px" },
